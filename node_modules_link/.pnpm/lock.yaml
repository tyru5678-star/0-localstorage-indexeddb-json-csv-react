  ...
  .:
    dependencies:
      '@napi-rs/canvas':
        ...
        version: 0.1.100
      '@oai/artifact-tool':
        specifier: file:./local-deps/-oai-artifact-tool-oai-artifact_tool-2.7.8.tgz
        version: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.7.8.tgz
      '@viz-js/viz':
        specifier: 3.25.0
        version: 3.25.0
      docx:
...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.7.8.tgz':
    resolution: {integrity: sha512-Ukz8AFUXypgb87vBSSRLmdPINns+NXcQUC/ownz7m4R3wMHUHkeCaOzlOgjj83wHJsdlXXkqe2EiWZSBKi64pA==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.7.8.tgz}
    version: 2.7.8
    bundledDependencies:
      - '@oai/walnut'
      - skia-canvas
